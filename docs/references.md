...
- [nix-community/nixos-generators: Collection of image builders](https://github.com/nix-community/nixos-generators)
...
- [nix-community/nixos-anywhere: install nixos everywhere via ssh](https://github.com/nix-community/nixos-anywhere?tab=readme-ov-file)
...
## Terraform
- [nix-community/terraform-nixos: A set of Terraform modules that are designed to deploy NixOS](https://github.com/nix-community/terraform-nixos/tree/master)
